                        ...
                        children: [
                            ...
                            validator: (_) =>
                                context
                                    ...
                                    .fold(
                                        (f) =>
                                        f.maybeMap(
                                          shortLength: (value)=> "Username must be minimum 3 characters length",
                            ...
                            validator: (_) =>
                                context
                                    ...
                                    .fold(
                                        ...
                                        f.maybeMap(
                                            empty: (value) => 'Empty value',
                                            passwordsDoNotMatch: (value) => 'Passwords do not match',
                                            orElse: () => null),
                                        (r) => null),
                            onChanged: (value) =>
                                context
                                    .read<SignUpFormBloc>()
                                    .add(SignUpFormEvent.confirmationPasswordChanged(value)),
                          ),
                          const SizedBox(
                            height: 16,
                          ),
                          ...
                          Center(
                            child: RichText(text: TextSpan(children: [
                              ...
                              WidgetSpan(child: InkWell(child:const Text('Sign in', style: TextStyle(color: Colors.green),), onTap: (){
