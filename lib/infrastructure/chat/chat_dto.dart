...
// @freezed
// abstract class ChatDto implements  _$MessageChatDto {
//   ChatDto._();
//   factory ChatDto(
//       {
...
//   factory ChatDto.fromDomain(Chat  chat) => ChatDto(members: chat.members.map((member) => member.reference).toList(),      date: chat.date,messages:chat.messages.map((message) => MessageChatDto.fromDomain(message)).toList(),documentReference: chat.
//   )
